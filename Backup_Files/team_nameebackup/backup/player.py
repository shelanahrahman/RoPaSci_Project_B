    ...
    if maximise:
        ...
        for cell, tokenTypes in playerDict.items():
            for tokenType in tokenTypes:
                ...
                #don't generate throws if you've already thrown 9 tokens
                if self_throws_did < 9:
...
###makes a value based on how many of team's tokens can beat opposing team's
    ...
    #get what type of tokens our current team has
...
#    print("team suff function")
 #   print(team)
 #   print(temp_team_types_list)
    ...
    def action(self):
        ...
        for cell, tokenTypes in self.selfdict.items():
            for tokenType in tokenTypes:
                ...
                #don't generate throws if u've already thrown nine.
...
#
     ...
     #         self.self_throw_distance = self.self_throw_distance + 1
      ...
      #        self.self_throw_distance = self.self_throw_distance - 1
        ...
        print("self throws did")
        print(self.self_throws_did)
        
        print("throws enemy did")
        print(self.enemy_throws_did)

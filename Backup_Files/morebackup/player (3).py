...
def minimax(playerDict, enemyDict, playerTeam, enemyTeam, playerMaxThrow, enemyMaxThrow, depth, maxdepth,  initialplayernumber, initialenemynumber, maximise=True):
    ...
    return_val= eval(playerDict, enemyDict, depth, maxdepth, initialplayernumber, initialenemynumber)
    ...
    def action(self):
        ...
        for cell, tokenType in self.selfdict.items():
            ...
            for possibleMove in possibleMovelst:
                ...
                moveEval= minimax(selfdictcopy, self.enemydict, self.team, self.enemyteam, self.self_throw_distance, self.enemy_throw_distance, 0, 2, len(selfdictcopy), len(self.enemydict), False)

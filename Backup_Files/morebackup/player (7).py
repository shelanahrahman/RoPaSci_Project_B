...
def find_team_dist_value(team, opposing_team):
    ...
    for t_coordinate, t_toktypes in team.items():
        ...
        if curr_closest_o_coordinate==None:
            return 0
    ...
    ave_team_dist= sum_team_dist/len(team.keys())* 10/9
...
class Player:
  ...
  #                  print(selfdictcopy)
    ...
    def update(self, opponent_action, player_action):
        ...
        # add to current turn
        if self.current_turn==17:
            print("Hi")
            print(self.selfdict.items())
 ...
 #       print("Temp eaten list")
  ...
  #      print(temp_eatenlist)
        ...
        if self.current_turn==17:
            print("Hi")
            print(self.selfdict, self.enemydict)

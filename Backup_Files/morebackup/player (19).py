...
def minimax(playerDict, enemyDict, playerTeam, enemyTeam, 
    ...
    if maximise:
      ...
      #              print(playerdictcopy)
                    ...
                    temp_eatenlist = update_tokens_eaten(playerdictcopy, enemydictcopy)  ### function can be modified
                    currentenemyeaten = currentenemyeaten + temp_eatenlist[0]
                    currentplayereaten = currentplayereaten + temp_eatenlist[1]
       #             print(playerdictcopy)
                   # update_tokens_eaten(playerDict, enemyDict)
                    ...
                    if possibleMove[0] == "THROW":
                        ...
                        maxval= minimax(playerdictcopy, enemydictcopy,
                    ...
                    if maxval > bestval:
                        bestval= maxval
                        #print("best max val so far", bestval)
    else:
        bestval= float('inf')
        #print()
#        print("ORIGINAL ENEMYDICT", enemyDict)
#        print("depth:", depth)
        #print()
    ...
    #            print("possibleMoveslst", possibleMovelst)
    #            print("----------------------------------------")
    #            i=0
     ...
     #               print("minimax inf relocating tokens of enemydict")
      ...
      #              print(enemydictcopy)
                    ...
                    currentenemyeaten = currentenemyeaten + temp_eatenlist[0]
                    currentplayereaten = currentplayereaten + temp_eatenlist[1]
      #              print("old enemy dict:", enemyDict)
      #              print("new enemy dict:", enemydictcopy)
                   # update_tokens_eaten(playerDict, enemyDict)
      #              print(enemydictcopy)
                    ...
                    if possibleMove[0] == "THROW":
                            ...
                            minival=  minimax(playerdictcopy, enemydictcopy, 
                            playerTeam, enemyTeam,
                            playerMaxThrow, enemyMaxThrow, 
                    ...
                    if minival < bestval:
                        bestval= minival
                        #print("best mini val so far", bestval)
...
def evaluation(playerDict, enemyDict, depth, maxdepth, 
 ...
 #   print("depth", depth)
    ...
    #print(currentenemyeaten, currentplayereaten, initialenemyeaten, initialplayereaten)
    ...
    #        print("player_sufficient_tokens!=0", player_sufficient_tokens)
            team_board_value= find_team_dist_value(playerDict, enemyDict)
        else:
            team_board_value= 0
        if enemy_sufficient_tokens!=0:
   #         print("enemy_sufficient_tokens", enemy_sufficient_tokens)
  ...
  #          print("sufficiency_diff",sufficiency_diff)
   #         print("board value:",board_value)
        return enemy_sufficient_tokens* opposing_team_board_value + team_board_value* player_sufficient_tokens
...
class Player:
    ...
    def action(self):
        ...
        if (len(self.selfdict)==0 or len(self.enemydict)==0) and self.self_throws_did<9:
  ...
  #                  print(selfdictcopy)
                    ...
                    temp_eatenlist = update_tokens_eaten(selfdictcopy, enemydictcopy)  ### function can be modified
                    currentenemyeaten = self.enemy_losses + temp_eatenlist[0]
                    currentplayereaten = self.self_losses + temp_eatenlist[1]
          ...
          #              self_throws_did, enemy_throws_did,
           ...
           #             initialplayereaten, initialenemyeaten, currentplayereaten, currentenemyeaten,
            #             current_turn, maximise=True):
                    ...
                    if possibleMove[0] == "THROW":
                        moveEval= minimax(selfdictcopy, enemydictcopy, 
                   ...
                   # print("move evaluation of", possibleMove, moveEval)
                    if (moveEval >= bestEval):
                        action = possibleMove
                        bestEval= moveEval
                       # print("BEST MAX VAL:", bestEval, action)
 ...
 #       print("Temp eaten list")
        temp_eatenlist = update_tokens_eaten( self.selfdict,self.enemydict)  ### function can be modified
  #      print(temp_eatenlist)

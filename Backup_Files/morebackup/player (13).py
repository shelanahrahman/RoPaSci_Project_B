...
def minimax(playerDict, enemyDict, playerTeam, enemyTeam,
        ...
        depth, maxdepth,  
        initialplayereaten, initialenemyeaten, current_self_losses, current_enemy_losses,
    ...
    if return_val!= "continue_minimax":
      #  print("YER A JOLLY FINISHED FELLA")
      #  print("depth", depth)
        #print("enemyDict", enemyDict)
        #print("playerDict", playerDict)
        #print("continue
        return [return_val, playerDict, enemyDict]
    ...
    if maximise:
      ...
      #              print(playerdictcopy)
       ...
       #             print(playerdictcopy)
                    temp_eatenlist = update_tokens_eaten(enemyDict, playerdictcopy)  ### function can be modified
                    #print(temp_eatenlist)
                    current_enemy_losses = current_enemy_losses+ temp_eatenlist[0]
                    current_self_losses = current_self_losses + temp_eatenlist[1]
                    ...
                    if possibleMove[0] == "THROW":
                        ...
                        return minimax(playerdictcopy, enemyDict,
                            ...
                            current_self_losses, current_enemy_losses,
                            current_turn, False)
     ...
     #               print("minimax inf relocating tokens of enemydict")
      ...
      #              print(enemydictcopy)
                    temp_eatenlist = update_tokens_eaten(enemydictcopy, playerDict)  ### function can be modified
                    #print(temp_eatenlist)
                    current_enemy_losses = current_enemy_losses+ temp_eatenlist[0]
                    current_self_losses = current_self_losses + temp_eatenlist[1]
                    if possibleMove[0] == "THROW":
...
def evaluation(playerDict, enemyDict, depth, maxdepth, 
    ...
    #reached depth limit
       ...
       #     exit()
        ...
        print("EVALUATION")
        print("playerdict:", playerDict)
        print("ATE:",  currentenemyeaten - initialenemyeaten)
        print("ATE:", currentplayereaten - initialplayereaten)
        print("enemydict:", enemyDict)
        print("BOARD VALUE:", team_board_value,  opposing_team_board_value)
        print("SUFFICIENCY:", player_sufficient_tokens,  enemy_sufficient_tokens)
        print("evaluation=:",-enemy_sufficient_tokens* opposing_team_board_value + player_sufficient_tokens* team_board_value)
        return -enemy_sufficient_tokens* opposing_team_board_value + player_sufficient_tokens* team_board_value
      ...
      #                  print(selfdictcopy)
              ...
              #              self_throws_did, enemy_throws_did,
               ...
               #             initialplayereaten, initialenemyeaten, currentplayereaten, currentenemyeaten,
                #             current_turn, maximise=True):
                        temp_eatenlist = update_tokens_eaten(self.enemydict, selfdictcopy)  ### function can be modified
                        #print(temp_eatenlist)
                        current_enemy_losses = self.enemy_losses + temp_eatenlist[0]
                        current_self_losses = self.self_losses + temp_eatenlist[1]
                        if self.current_turn==10:
                            print("HEREEEEEE",current_enemy_losses, current_self_losses)
                        if possibleMove[0] == "THROW":
                        ...
                        #print("MOVE EVAL VALUE ", moveEval[0])
                        #print("playerdict ", moveEval[1])
                        #print("enemydict ", moveEval[2])


                       # print("move evaluation of", possibleMove, moveEval)
                        if (moveEval[0] >= bestEval):
                            action = possibleMove
                            bestEval= moveEval[0]
                           # print("BEST VAL:", bestEval, action)
                            debugginglist = moveEval
            ...
            print()
            print()
            print("JUST BEFORE ACTION")
            print("current turn", self.current_turn)
            print("team", self.team)
            print()
            print("BEST EVAL VALUE", debugginglist[0])
            print()
            print("current enemydict", self.enemydict)
            print("predicted future enemydict ", debugginglist[2])
            print()
            print("current player dict", self.selfdict)
            print("future playerdict in response to predicted enemydict", debugginglist[1])
            print()
            print()

...
def update_tokens_eaten(dict1, dict2):
     ...
     #   print("dict 1", dict1)
      #  print("dict2", dict2)
      #  print("temp_eatenlist", temp_eatenlist)
      #  print()
...
def evaluate(playerDict, enemyDict): 
 ...
 #   print("depth", depth)
    ...
    temp_eatenlist = update_tokens_eaten(scoringPlayerDict, scoringEnemyDict) 
    
    playereaten = temp_eatenlist[0]
    enemyeaten = temp_eatenlist[1]
    ## if this move causes an enemy token to be eaten
    if playereaten > enemyeaten:
        score = score + 100
    #player loses and gets eaten
    elif enemyeaten > playereaten:
        score = score - 100
...
class Player:
    ...
    #   print("player choide", player_choice)
  ...
  #      print("Relocating tokens for both teams")
        ...
        #print("selfdict post relocation", self.selfdict)
